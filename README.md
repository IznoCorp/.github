...
The workshops of IznoCorp mainly work on:

- tools for developers in a hurry;
- libraries designed in secret basements;
- APIs that obey at the snap of a finger;
...
Every project follows the great principles of the house:

1. Identify a problem.
2. Devise a Machiavellian plan.
3. Write code.
4. Discover that the plan was too complicated.
5. Simplify.
6. Commit.
...
Contributions are welcome, provided they respect the imperial order:

- propose useful improvements;
- avoid overly twisted plans;
